...
public class QDelivery extends EntityPathBase<Delivery> {
    ...
    private static final long serialVersionUID = 2109028062L;
    ...
    public final study.project.domain.order.QOrder order;
    ...
    public QDelivery(Class<? extends Delivery> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new study.project.domain.order.QOrder(forProperty("order"), inits.get("order")) : null;
    }
