...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = 979653278L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QOrder order = new QOrder("order1");

    public final DateTimePath<java.time.LocalDateTime> createOrder = createDateTime("createOrder", java.time.LocalDateTime.class);
